...
class ReportingDialogLayout(list):
    ...
    def __init__(self,datasets):
        ...
        dataset_buttons = [
            [psg.Button(self.PANDAS_PROFILING_REPORT, button_color=("#404040", "#E0FBFC"))],
        ...
        report_type_frame = psg.Frame('Report Types',layout=[[dataset_container,dataset_buttons_column]])
        ...
        planned_reports_frame = psg.Frame('Planned Reports',layout=[[planned_reports,remove_report]])
